...
If a previous query attempt returned an error, analyze it and generate a corrected query.
Make sure to address ALL constraints mentioned in the question without exception.
"""
...
- Referencing columns or tables that do not exist in the schema
